...
export default withWiki(
    ...
    wiki,
    {
        slug: 'hailstorm',
        category: 'Magic',
        note: 'Wiki rank costs and effects; six seconds per turn. Turns and training use Rebirth Dungeon rules. One charge per cast; splash hits every living enemy.',
