...
export default withWiki(
    define('Meteor Strike', 'magic', 0, 0, 0, {
    ...
    wiki,
    {
        slug: 'meteor-strike',
        category: 'Magic',
        note: 'Wiki rank costs and effects; six seconds per turn. Turns and training use Rebirth Dungeon rules. One magical impact per enemy; lingering fire and physical impact are not simulated.',
