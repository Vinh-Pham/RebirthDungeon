...
- Use oxfmt for files you touch: single quotes, trailing commas, 100-column target, and LF line endings. The existing `.editorconfig` has conflicting legacy newline settings; avoid unrelated line-ending or whole-repository formatting churn.
