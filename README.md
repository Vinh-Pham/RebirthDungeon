...
- `io.github.quillraven.libktx:ktx-*` 1.14.2-rc1 — the full Kotlin DSL module set, migrated from the earlier `io.github.libktx` 1.13.1-rc1 seven-module adoption. 1.14.2-rc1 is built against this project's exact pins (gdx 1.14.2, artemis-odb 2.3.0, kotlin-stdlib 2.4.10), which removes the previous gdx-baseline mismatch.
