[Skip to main content](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys#__docusaurus_skipToContent_fallback)
...
## Arguments [​](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys\#arguments "Direct link to Arguments")

### `keys` [​](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys\#keys "Direct link to keys")
...
#### Listen to all keys [​](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys\#listen-to-all-keys "Direct link to Listen to all keys")

```jsx
useHotkeys('*', (_, handler) => alert(handler.key))
```

#### Use modifiers [​](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys\#use-modifiers "Direct link to Use modifiers")

```jsx
useHotkeys('ctrl+s, shift+w', () => alert('We're using modifiers now!'))
```

#### Use function keys [​](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys\#use-function-keys "Direct link to Use function keys")

```jsx
useHotkeys('f5', () => alert('F5 was pressed'))
```

#### Multiple key combinations [​](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys\#multiple-key-combinations "Direct link to Multiple key combinations")
...
### `callback` [​](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys\#callback "Direct link to callback")
...
#### `event` [​](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys\#event "Direct link to event")
...
#### `handler` [​](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys\#handler "Direct link to handler")
...
### `options` [​](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys\#options "Direct link to options")
...
#### `enabled` [​](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys\#enabled "Direct link to enabled")
...
#### `enableOnFormTags` [​](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys\#enableonformtags "Direct link to enableonformtags")
...
#### `enableOnContentEditable` [​](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys\#enableoncontenteditable "Direct link to enableoncontenteditable")
...
#### `ignoreEventWhen` [​](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys\#ignoreeventwhen "Direct link to ignoreeventwhen")
...
#### `splitKey` [​](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys\#splitkey "Direct link to splitkey")
...
#### `delimiter` [​](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys\#delimiter "Direct link to delimiter")
...
#### `sequenceSplitKey` [​](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys\#sequencesplitkey "Direct link to sequencesplitkey")
...
#### `scopes` [​](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys\#scopes "Direct link to scopes")

```ts
scopes: string | string[] // default: "*"
```

Assign the hotkey to one or more scopes. Scopes let you group hotkeys and enable or disable them together via `HotkeysProvider`. See the [Grouping Hotkeys](https://react-hotkeys-hook.vercel.app/docs/documentation/hotkeys-provider) documentation for details.

#### `keyup` [​](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys\#keyup "Direct link to keyup")
...
#### `keydown` [​](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys\#keydown "Direct link to keydown")
...
#### `preventDefault` [​](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys\#preventdefault "Direct link to preventdefault")
...
#### `description` [​](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys\#description "Direct link to description")
...
#### `document` [​](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys\#document "Direct link to document")
...
#### `ignoreModifiers` [​](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys\#ignoremodifiers "Direct link to ignoremodifiers")
...
\
#### `useKey` [​](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys\#usekey "Direct link to usekey")\
\
```ts\
...
\
#### `sequenceTimeoutMs` [​](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys\#sequencetimeoutms "Direct link to sequencetimeoutms")\
\
```ts\
...
\
#### `eventListenerOptions` [​](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys\#eventlisteneroptions "Direct link to eventlisteneroptions")\
\
```ts\
...
\
#### `metadata` [​](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys\#metadata "Direct link to metadata")\
\
```ts\
...
* * *\
\
### `deps` [​](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys\#deps "Direct link to deps")\
\
```ts\
deps: any[] // default: []\
```\
...
\
See the [Callback Dependencies](https://react-hotkeys-hook.vercel.app/docs/documentation/useHotkeys/setting-callback-dependencies) documentation for examples.\
\
## Return value [​](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys\#return-value "Direct link to Return value")\
\
### `React.RefCallback<T | null>` [​](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys\#reactrefcallbackt--null "Direct link to reactrefcallbackt--null")\
\
...
Count: 0\
\
Focusing this area won't trigger the hotkey.Focusing this area will trigger the hotkey.\
\
...
Focusing this area will trigger the hotkey.\
\
## Function signature overloads [​](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys\#function-signature-overloads "Direct link to Function signature overloads")\
\
...
```\
\
- [Arguments](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys#arguments)\
  - [`keys`](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys#keys)\
  - [`callback`](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys#callback)\
  - [`options`](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys#options)\
  - [`deps`](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys#deps)\
- [Return value](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys#return-value)\
  - [`React.RefCallback<T | null>`](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys#reactrefcallbackt--null)\
- [Function signature overloads](https://react-hotkeys-hook.vercel.app/docs/api/use-hotkeys#function-signature-overloads)