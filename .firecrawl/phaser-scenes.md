[Skip to main content](https://docs.phaser.io/phaser/concepts/scenes#__docusaurus_skipToContent_fallback)
...
## What is a Scene? [​](https://docs.phaser.io/phaser/concepts/scenes\#what-is-a-scene "Direct link to What is a Scene?")
...
### What does Game still control? [​](https://docs.phaser.io/phaser/concepts/scenes\#what-does-game-still-control "Direct link to What does Game still control?")
...
### What happens when you create a Scene [​](https://docs.phaser.io/phaser/concepts/scenes\#what-happens-when-you-create-a-scene "Direct link to What happens when you create a Scene")
...
### Game configuration [​](https://docs.phaser.io/phaser/concepts/scenes\#game-configuration "Direct link to Game configuration")
...
#### Scene Settings [​](https://docs.phaser.io/phaser/concepts/scenes\#scene-settings "Direct link to Scene Settings")
...
#### Scene Systems [​](https://docs.phaser.io/phaser/concepts/scenes\#scene-systems "Direct link to Scene Systems")
...
#### Configuring Plugins [​](https://docs.phaser.io/phaser/concepts/scenes\#configuring-plugins "Direct link to Configuring Plugins")
...
#### Scene Injection Map [​](https://docs.phaser.io/phaser/concepts/scenes\#scene-injection-map "Direct link to Scene Injection Map")
...
## Scene Callbacks [​](https://docs.phaser.io/phaser/concepts/scenes\#scene-callbacks "Direct link to Scene Callbacks")
...
## Scene creation [​](https://docs.phaser.io/phaser/concepts/scenes\#scene-creation "Direct link to Scene creation")
...
### Scene creation basics [​](https://docs.phaser.io/phaser/concepts/scenes\#scene-creation-basics "Direct link to Scene creation basics")

#### Using an ES6 class [​](https://docs.phaser.io/phaser/concepts/scenes\#using-an-es6-class "Direct link to Using an ES6 class")
...
- `data` : Parameters passed from [adding new scene](https://docs.phaser.io/phaser/concepts/scenes#add-a-scene-from-a-config-object), or [starting scene](https://docs.phaser.io/phaser/concepts/scenes#start)

#### Using a Class [​](https://docs.phaser.io/phaser/concepts/scenes\#using-a-class "Direct link to Using a Class")
...
#### Overriding default callbacks [​](https://docs.phaser.io/phaser/concepts/scenes\#overriding-default-callbacks "Direct link to Overriding default callbacks")
...
### Creating a single-scene game [​](https://docs.phaser.io/phaser/concepts/scenes\#creating-a-single-scene-game "Direct link to Creating a single-scene game")

It's simplest to use the game config. When only one scene is given, it is started automatically.

#### A scene config in the game config [​](https://docs.phaser.io/phaser/concepts/scenes\#a-scene-config-in-the-game-config "Direct link to A scene config in the game config")
...
#### A scene class in the game config [​](https://docs.phaser.io/phaser/concepts/scenes\#a-scene-class-in-the-game-config "Direct link to A scene class in the game config")
...
#### A scene instance in the game config [​](https://docs.phaser.io/phaser/concepts/scenes\#a-scene-instance-in-the-game-config "Direct link to A scene instance in the game config")
...
#### Add a scene from a config object [​](https://docs.phaser.io/phaser/concepts/scenes\#add-a-scene-from-a-config-object "Direct link to Add a scene from a config object")
...
#### Add a scene from a scene class [​](https://docs.phaser.io/phaser/concepts/scenes\#add-a-scene-from-a-scene-class "Direct link to Add a scene from a scene class")
...
#### Add a scene from a scene instance [​](https://docs.phaser.io/phaser/concepts/scenes\#add-a-scene-from-a-scene-instance "Direct link to Add a scene from a scene instance")
...
### Creating a multi-scene game [​](https://docs.phaser.io/phaser/concepts/scenes\#creating-a-multi-scene-game "Direct link to Creating a multi-scene game")
...
#### Multiple scene configs in the game config [​](https://docs.phaser.io/phaser/concepts/scenes\#multiple-scene-configs-in-the-game-config "Direct link to Multiple scene configs in the game config")
...
#### Multiple scene instances in the game config [​](https://docs.phaser.io/phaser/concepts/scenes\#multiple-scene-instances-in-the-game-config "Direct link to Multiple scene instances in the game config")
...
You can [configure scenes](https://docs.phaser.io/phaser/concepts/scenes#scene-configuration-object) in their constructors instead if you like.

#### Multiple scenes from a base config [​](https://docs.phaser.io/phaser/concepts/scenes\#multiple-scenes-from-a-base-config "Direct link to Multiple scenes from a base config")
...
#### Multiple scenes from one class [​](https://docs.phaser.io/phaser/concepts/scenes\#multiple-scenes-from-one-class "Direct link to Multiple scenes from one class")
...
##### A 2-scene game [​](https://docs.phaser.io/phaser/concepts/scenes\#a-2-scene-game "Direct link to A 2-scene game")
...
### Listing scenes after game boot [​](https://docs.phaser.io/phaser/concepts/scenes\#listing-scenes-after-game-boot "Direct link to Listing scenes after game boot")
...
## Scene Configuration Object [​](https://docs.phaser.io/phaser/concepts/scenes\#scene-configuration-object "Direct link to Scene Configuration Object")
...
- `pack` : An optional [Loader Packfile](https://docs.phaser.io/phaser/concepts/loader#file-pack) to be loaded before the Scene begins.

- `cameras` : An optional [Camera configuration object](https://docs.phaser.io/phaser/concepts/cameras#create-cameras-from-json).
...
```
  ...
  - `arcade` : [Arcade Physics configuration](https://docs.phaser.io/phaser/concepts/physics/arcade#configuration).
  - `matter` : [Matter Physics configuration](https://docs.phaser.io/phaser/concepts/physics/matter#configuration).
...
## Scene life cycle [​](https://docs.phaser.io/phaser/concepts/scenes\#scene-life-cycle "Direct link to Scene life cycle")
...
### Flowchart: Scene life cycle [​](https://docs.phaser.io/phaser/concepts/scenes\#flowchart-scene-life-cycle "Direct link to Flowchart: Scene life cycle")
...
### Changing scenes [​](https://docs.phaser.io/phaser/concepts/scenes\#changing-scenes "Direct link to Changing scenes")

There are a lot of ways, because it depends on what you want to do, and Phaser lets you run multiple scenes at once.

#### Scene operations [​](https://docs.phaser.io/phaser/concepts/scenes\#scene-operations "Direct link to Scene operations")
...
#### Scene control methods [​](https://docs.phaser.io/phaser/concepts/scenes\#scene-control-methods "Direct link to Scene control methods")

##### The simple methods [​](https://docs.phaser.io/phaser/concepts/scenes\#the-simple-methods "Direct link to The simple methods")

- `launch()` and `stop()` do start and shutdown.
- `sleep()` and `wake()` do sleep and wake.
- `pause()` and `resume()` do pause and resume.

##### The conditional methods [​](https://docs.phaser.io/phaser/concepts/scenes\#the-conditional-methods "Direct link to The conditional methods")

- `run()` may start, wake, or resume a scene
- `switch()` may start or wake a scene

##### The "double" methods [​](https://docs.phaser.io/phaser/concepts/scenes\#the-double-methods "Direct link to The \"double\" methods")
...
##### start() [​](https://docs.phaser.io/phaser/concepts/scenes\#start "Direct link to start()")
...
##### switch() [​](https://docs.phaser.io/phaser/concepts/scenes\#switch "Direct link to switch()")
...
##### launch() [​](https://docs.phaser.io/phaser/concepts/scenes\#launch "Direct link to launch()")

`launch()` starts or restarts the target scene. It never resumes or wakes — cf. `run()`.

##### run() [​](https://docs.phaser.io/phaser/concepts/scenes\#run "Direct link to run()")

`run()` resumes the target scene if paused; wakes it if sleeping; restarts it if running; and starts it otherwise.

### Problems restarting a scene [​](https://docs.phaser.io/phaser/concepts/scenes\#problems-restarting-a-scene "Direct link to Problems restarting a scene")
...
#### Example: bad state after restart [​](https://docs.phaser.io/phaser/concepts/scenes\#example-bad-state-after-restart "Direct link to Example: bad state after restart")
...
#### Example: invalid game objects after restart [​](https://docs.phaser.io/phaser/concepts/scenes\#example-invalid-game-objects-after-restart "Direct link to Example: invalid game objects after restart")
...
### Removing a scene [​](https://docs.phaser.io/phaser/concepts/scenes\#removing-a-scene "Direct link to Removing a scene")
...
#### Replacing a scene with the same key [​](https://docs.phaser.io/phaser/concepts/scenes\#replacing-a-scene-with-the-same-key "Direct link to Replacing a scene with the same key")

You can't reuse the key until the original scene is removed.

##### A scene removing itself [​](https://docs.phaser.io/phaser/concepts/scenes\#a-scene-removing-itself "Direct link to A scene removing itself")
...
##### A second scene removing the first [​](https://docs.phaser.io/phaser/concepts/scenes\#a-second-scene-removing-the-first "Direct link to A second scene removing the first")
...
##### An alternative [​](https://docs.phaser.io/phaser/concepts/scenes\#an-alternative "Direct link to An alternative")
...
## Scene systems and plugins [​](https://docs.phaser.io/phaser/concepts/scenes\#scene-systems-and-plugins "Direct link to Scene systems and plugins")
...
### Table: Systems and plugins [​](https://docs.phaser.io/phaser/concepts/scenes\#table-systems-and-plugins "Direct link to Table: Systems and plugins")
...
## Rendering [​](https://docs.phaser.io/phaser/concepts/scenes\#rendering "Direct link to Rendering")
...
## Scene Events [​](https://docs.phaser.io/phaser/concepts/scenes\#scene-events "Direct link to Scene Events")
...
## Author Credits [​](https://docs.phaser.io/phaser/concepts/scenes\#author-credits "Direct link to Author Credits")
...
- [What is a Scene?](https://docs.phaser.io/phaser/concepts/scenes#what-is-a-scene)
  - [What does Game still control?](https://docs.phaser.io/phaser/concepts/scenes#what-does-game-still-control)
  - [What happens when you create a Scene](https://docs.phaser.io/phaser/concepts/scenes#what-happens-when-you-create-a-scene)
  - [Game configuration](https://docs.phaser.io/phaser/concepts/scenes#game-configuration)
- [Scene Callbacks](https://docs.phaser.io/phaser/concepts/scenes#scene-callbacks)
- [Scene creation](https://docs.phaser.io/phaser/concepts/scenes#scene-creation)
  - [Scene creation basics](https://docs.phaser.io/phaser/concepts/scenes#scene-creation-basics)
  - [Creating a single-scene game](https://docs.phaser.io/phaser/concepts/scenes#creating-a-single-scene-game)
  - [Creating a multi-scene game](https://docs.phaser.io/phaser/concepts/scenes#creating-a-multi-scene-game)
  - [Listing scenes after game boot](https://docs.phaser.io/phaser/concepts/scenes#listing-scenes-after-game-boot)
- [Scene Configuration Object](https://docs.phaser.io/phaser/concepts/scenes#scene-configuration-object)
- [Scene life cycle](https://docs.phaser.io/phaser/concepts/scenes#scene-life-cycle)
  - [Flowchart: Scene life cycle](https://docs.phaser.io/phaser/concepts/scenes#flowchart-scene-life-cycle)
  - [Changing scenes](https://docs.phaser.io/phaser/concepts/scenes#changing-scenes)
  - [Problems restarting a scene](https://docs.phaser.io/phaser/concepts/scenes#problems-restarting-a-scene)
  - [Removing a scene](https://docs.phaser.io/phaser/concepts/scenes#removing-a-scene)
- [Scene systems and plugins](https://docs.phaser.io/phaser/concepts/scenes#scene-systems-and-plugins)
  - [Table: Systems and plugins](https://docs.phaser.io/phaser/concepts/scenes#table-systems-and-plugins)
- [Rendering](https://docs.phaser.io/phaser/concepts/scenes#rendering)
- [Scene Events](https://docs.phaser.io/phaser/concepts/scenes#scene-events)
- [Author Credits](https://docs.phaser.io/phaser/concepts/scenes#author-credits)