...
export default withWiki(
    define('Shockwave', 'magic', 0, 0, 0.2, 0, {
    ...
    wiki,
    {
        slug: 'shockwave',
        category: 'Magic',
        note: 'Wiki rank costs and effects; six seconds per turn. Dice and training use Rebirth Dungeon rules. One charge per cast; area spells hit every living enemy. Real-time stun, charge storage, and secondary explosions are not simulated. Mana cost is a percentage of maximum mana; cooldown resets are not simulated.',
