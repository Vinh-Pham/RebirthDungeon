...
data class CommandResult private constructor(val reason: Reason) {
    enum class Reason {
        ...
        ACCEPTED,
        NOT_PLAYER_TURN, STALE_SESSION, SAVE_REQUIRED, INVALID_PHASE, INVALID_SKILL, INVALID_TARGET, EQUIPMENT_REQUIRED, COOLDOWN, INSUFFICIENT_HP, INSUFFICIENT_MP, INSUFFICIENT_SP, TERMINAL, ITEM_UNAVAILABLE, ITEM_USED, ACTION_AVAILABLE
    }
