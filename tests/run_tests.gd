...
func _run() -> void:
	...
	if not negative:
		...
		failures.append_array(load("res://tests/unit/quest_fixture.gd").new().run_part2())
		failures.append_array(load("res://tests/unit/enchant_fixture.gd").new().run())
		failures.append_array(load("res://tests/unit/enchant_fixture.gd").new().run_part2())
		failures.append_array(load("res://tests/unit/enchant_fixture.gd").new().run_part3())
		...
		failures.append_array(load("res://tests/unit/combat10_fixture.gd").new().run())
		...
		failures.append_array(await load("res://tests/integration/save_fixture.gd").new().run(self))
		failures.append_array(await load("res://tests/integration/town_services_fixture.gd").new().run(self))
		failures.append_array(await load("res://tests/integration/progression_fixture.gd").new().run(self))
		failures.append_array(await load("res://tests/integration/quest_fixture.gd").new().run(self))
