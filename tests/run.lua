...
sys={get_config_string=function(_,default) return default end}
socket={gettime=function() return 0 end}
event_context_manager={get=function() return nil end,set=function() end,log_error=function(e) error(e) end}
