...
M.items = {
	...
	axe = {
		...
		durability = 20,
		tile = "tile_0104",
		description = "A one-handed axe. Activates Axe Mastery.",
	},
	greatsword = {
		name = "Greatsword",
		price = 60,
		...
		durability = 20,
		tile = "tile_0104",
		description = "Two-handed sword. Enhances Smash; needs a free left hand.",
	},
	small_shield = {
		name = "Small Shield",
		price = 25,
		...
		shield_size = "small",
		tile = "tile_0090",
		description = "Absorbs 50% of damage on a guarded hit.",
	},
	medium_shield = {
		name = "Medium Shield",
		price = 40,
		...
		shield_size = "medium",
		tile = "tile_0090",
		description = "Absorbs 70% of damage on a guarded hit.",
	},
	large_shield = {
		name = "Large Shield",
		price = 60,
		...
		shield_size = "large",
		tile = "tile_0090",
		description = "Absorbs all damage on a guarded hit.",
	},
	bow = {
		name = "Ashwood Bow",
		price = 40,
...
M.services = {
	...
	blacksmith = {
		...
		y = 6,
		tile = "tile_0086",
		stock = { "sword", "bow", "guns", "wand", "axe", "greatsword", "small_shield", "medium_shield", "large_shield" },
	},
	shop = {
		name = "Odd",
		title = "General Shop",
