# References: Godot engine and game inspiration

Gameplay inspiration research date: 2026-09-07 (America/Los_Angeles). Companion to [Game Overview](overview.md). Those historical source notes are retained below and were not re-researched during the Godot reset.

## Godot engine sources

Retrieved with **Firecrawl CLI on 2026-09-10 (America/Los_Angeles)** from the official Godot documentation. Inspected stable pages identify themselves as **Godot 4.7**, matching the project feature version. The `stable` alias can change; Phase 0 must record the exact editor/templates build, and future implementation must consult matching docs. Engine behavior comes from these sources; the game's transaction protocol, folder layout, phases and economy are project design decisions.

| Official source | Local Firecrawl snapshot | Applied to |
| --- | --- | --- |
| [Nodes and scenes](https://docs.godotengine.org/en/stable/getting_started/step_by_step/nodes_and_scenes.html) | `.firecrawl/godot-scenes.md` | Reusable node trees and main-scene composition |
| [Resources](https://docs.godotengine.org/en/stable/tutorials/scripting/resources.html) | `.firecrawl/godot-resources.md` | Authored data and shared resource lifetime |
| [2D movement](https://docs.godotengine.org/en/stable/tutorials/2d/2d_movement.html) | `.firecrawl/godot-movement.md` | CharacterBody2D movement in physics updates |
| [Navigation agents](https://docs.godotengine.org/en/stable/tutorials/navigation/navigation_using_navigationagents.html) | `.firecrawl/godot-navigation.md` | Path following and map synchronization |
| [TileSets](https://docs.godotengine.org/en/stable/tutorials/2d/using_tilesets.html) | `.firecrawl/godot-tiles.md` | Tile art, collision and navigation authoring |
| [Containers](https://docs.godotengine.org/en/stable/tutorials/ui/gui_containers.html) | `.firecrawl/godot-ui.md` | Control layout ownership |
| [Input events](https://docs.godotengine.org/en/stable/tutorials/inputs/inputevent.html) | `.firecrawl/godot-input.md` | InputMap and GUI/world event flow |
| [RandomNumberGenerator](https://docs.godotengine.org/en/stable/classes/class_randomnumbergenerator.html) | `.firecrawl/godot-rng.md` | Seed/state restore and engine-version boundary |
| [Saving games](https://docs.godotengine.org/en/stable/tutorials/io/saving_games.html) | `.firecrawl/godot-saving.md` | FileAccess, user:// and explicit JSON conversion |
| [Command line](https://docs.godotengine.org/en/stable/tutorials/editor/command_line_tutorial.html) | `.firecrawl/godot-cli.md` | Headless import, script execution and export |
| [Android export](https://docs.godotengine.org/en/stable/tutorials/export/exporting_for_android.html) | `.firecrawl/godot-android.md` | Templates, SDK/JDK setup and packaging |
| [iOS export](https://docs.godotengine.org/en/stable/tutorials/export/exporting_for_ios.html) | `.firecrawl/godot-ios.md` | macOS/Xcode export and signing requirements |

Snapshots are stored at the project root in the ignored `.firecrawl/` directory. They were read during this rewrite; they are research caches, not runtime dependencies or test evidence. Reproduce a fetch with:

```sh
firecrawl scrape 'https://docs.godotengine.org/en/stable/tutorials/scripting/resources.html' --only-main-content -o .firecrawl/godot-resources.md
```

Legacy `.firecrawl/mabinogi-*`, Dicero and UI research paths mentioned in gameplay documents refer to the earlier research workspace and are not assumed present in this scaffold. Their external URLs and original dates are retained for provenance. No historical citation establishes current Godot implementation.
