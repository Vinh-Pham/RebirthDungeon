...
this.load.atlas(
    'mainmenu',
    ['images/MainMenu.png', 'images/MainMenu-n.png'],
    'images/MainMenu.json',
);
```
...
this.load.bitmapFont(
    'goldenFont',
    ['images/GoldFont.png', 'images/GoldFont-n.png'],
    'images/GoldFont.xml',
);
```
...
```javascript
this.load.spritesheet('logo', ['images/AtariLogo.png', 'images/AtariLogo-n.png'], {
    frameWidth: 256,
    frameHeight: 80,
});
```
...
preload();
{
    ...
    this.load.texture('yourAtlas', {
        ...
        PVRTC: {
            type: 'PVR',
            multiAtlasURL: `${path}/textures-pvrtc-4bpp-rgba.json`,
            multiPath: `${path}`,
        },
