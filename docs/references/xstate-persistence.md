...
Source: https://stately.ai/docs/persistence
...
[Actors](https://stately.ai/docs/actors) can persist their internal state and restore it later. **Persistence** refers to storing the state of an actor in persistent storage, such as localStorage or a database. **Restoration** refers to restoring the state of an actor from persistent storage.
...
## [Persisting state](https://stately.ai/docs/persistence#persisting-state)
...
## [Restoring state](https://stately.ai/docs/persistence#restoring-state)
...
## [Deep persistence](https://stately.ai/docs/persistence#deep-persistence)

Persisting & restoring state from machine actors is deep; all [invoked](https://stately.ai/docs/invoke) & [spawned actors](https://stately.ai/docs/spawn) will be persisted and restored recursively.
...
## [Persisting state machine values](https://stately.ai/docs/persistence#persisting-state-machine-values)
...
## [Event sourcing](https://stately.ai/docs/persistence#event-sourcing)

An alternative to persisting state is **event sourcing**, which is a way of restoring the state of an actor by replaying the [events](https://stately.ai/docs/transitions) that led to that state. Event sourcing can be more reliable than persisting state, because it is less prone to [incompatible state](https://stately.ai/docs/persistence#caveats) and it also allows you to replay actions.

One way to implement event sourcing is to persist the events as they happen using the [inspection API](https://stately.ai/docs/inspection), and then replay them to restore the state of the actor:
...
## [Caveats](https://stately.ai/docs/persistence#caveats)
...
- Replaying actions: actions that have already been executed will not be re-executed. [Event sourcing](https://stately.ai/docs/persistence#event-sourcing) is preferred for this use-case.
...
## [Persistence cheatsheet](https://stately.ai/docs/persistence#persistence-cheatsheet)

### [Cheatsheet: persisting state](https://stately.ai/docs/persistence#cheatsheet-persisting-state)

```
const persistedState = actor.getPersistedSnapshot();
```

### [Cheatsheet: restoring state](https://stately.ai/docs/persistence#cheatsheet-restoring-state)
...
## [Resources](https://stately.ai/docs/persistence#resources)

- [Blog: Persisting state in XState](https://stately.ai/blog/2023-10-02-persisting-state)

[History states\\
\\
Previous Page](https://stately.ai/docs/history-states) [Tags\\
\\
Next Page](https://stately.ai/docs/tags)

### On this page

[Persisting state](https://stately.ai/docs/persistence#persisting-state) [Restoring state](https://stately.ai/docs/persistence#restoring-state) [Deep persistence](https://stately.ai/docs/persistence#deep-persistence) [Persisting state machine values](https://stately.ai/docs/persistence#persisting-state-machine-values) [Event sourcing](https://stately.ai/docs/persistence#event-sourcing) [Caveats](https://stately.ai/docs/persistence#caveats) [Persistence cheatsheet](https://stately.ai/docs/persistence#persistence-cheatsheet) [Cheatsheet: persisting state](https://stately.ai/docs/persistence#cheatsheet-persisting-state) [Cheatsheet: restoring state](https://stately.ai/docs/persistence#cheatsheet-restoring-state) [Resources](https://stately.ai/docs/persistence#resources)
